...
const ContactForm = () => {
    ...
    // Slide-in observer for header and form
    useEffect(() => {
    ...
    return (
        <section className="form-section glow-bottom" id="contactUs">
            <div className="contactWrapper">
                {/* left angled line */}
                <div className="vertical-line-left-CUS glow"/>
                <div className="vertical-line-right-CUS glow"/>
                {/* main content stack */}
                <Stack as="div" direction="vertical" gap={4} className="stackContent">
                    {/* Header column */}
                    <div ref={textRef} className="slideTextDown headerBox">
                        <img
                            src={logoIcon}
                            alt="ISolve logo"
                            style={{maxWidth: "100px"}}
                            className="glow form-img"
                        />
                    ...
                    <form
                        ...
                        className="slideFormUp form-box weak-glow"
                    >
                        {/* Web3Forms hidden fields */}
                        <input
                            type="hidden"
                            name="access_key"
                            value="71fff338-ae3c-423e-920f-69826bc8747e"
                        />
                        <input
                            type="hidden"
                            name="subject"
