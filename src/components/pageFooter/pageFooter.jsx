    ...
    return (
        <div className="pageFooter">
            ...
            <div className="pageFooterInfo">
                <h1
                    ref={textRef}
                    className="fade-in slide-right static-glow-animatable headFormat"
                >
                    Bring your brand to life online — with power, polish, and purpose.
                </h1>
                <div
                    ref={imagesRef}
                    className="animatable fade-in slide-left mediaBox"
                >
                ...
                <div
                    ref={copyRightRef}
                    className="fade-in slide-right static-glow-animatable bodyFormat"
                >
                    © 2025 ISolve | All rights reserved.
                </div>
            </div>

            {/* duplicate right line removed—you already have one above */}
        </div>
    );
};
